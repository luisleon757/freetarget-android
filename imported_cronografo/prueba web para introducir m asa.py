...
# Página HTML con JavaScript para actualizar los datos dinámicamente
def generate_html():
    html = """<!DOCTYPE html>
    <html>
    <head>
        ...
        <script>
            ...
            setInterval(actualizarDatos, 1000);  // Actualiza cada segundo
        </script>
    </head>
    <body>
        <h1>Ultimo Disparo</h1>
        <p><strong>Disparo numero:</strong> <span id="disparo">0</span></p>
        <p><strong>Velocidad (MPS):</strong> <span id="velocidad">0.00</span></p>
        <p><strong>Media (MPS):</strong> <span id="media">0.00</span></p>
        <p><strong>Energia (J):</strong> <span id="energia">0.0000</span></p>
    </body>
    </html>"""
    return html
...
while True:
    ...
    # Verificar si la solicitud es para los datos en JSON
    ...
    else:  # Servir la página HTML principal
        html = generate_html()
    ...
    # Leer sensores y calcular velocidad y potencia solo cuando haya disparo
